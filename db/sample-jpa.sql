...
CREATE TABLE IF NOT EXISTS `status` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uq_status_name` (`name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `bio` TEXT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `uq_user_name` (`name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `todo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_todo_pk_status` (`status` ASC),
  INDEX `fk_todo_pk_user` (`user` ASC),
  INDEX `fk_todo_parent_pk_todo` (`parent` ASC),
...
INSERT INTO `status` (`id`, `name`) VALUES (1, 'WORKING');
INSERT INTO `status` (`id`, `name`) VALUES (2, 'DONE');
INSERT INTO `status` (`id`, `name`) VALUES (3, 'CANCEL');
